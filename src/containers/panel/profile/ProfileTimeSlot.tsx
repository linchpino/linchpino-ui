                            ...
                            <div className='flex items-center w-full flex-col sm:flex-row '>
                                ...
                                <div className='flex gap-x-2 ml-2 flex-wrap justify-center gap-y-3 mt-2 sm:mt-0'>
                                    {duration.map(durationItem => {
                                        return (
                                            <button onClick={() => setSelectedDuration(durationItem.time)}
                                                    key={durationItem.id}
                                                    className={`p-2 min-w-[3.9rem] text-xs rounded-3xl flex items-center justify-center border-[.1px] ${selectedDuration === durationItem.time && 'text-[#F2A926]'} ${selectedDuration === durationItem.time && 'border-[#F2A926]'} `}>
                                                {durationItem.time}
                                            </button>
                                        )
                                    })}
