...
const Sidebar = () => {
    ...
    const links = [
        {
            href: '/panel/interviews', label: 'Interviews', icon: <BsPersonVcard
                size={20}/>, roles: ['JOB_SEEKER', 'MENTOR']
        },
        {
            href: '/panel/profile', label: 'Profile', icon: <BsFillPersonFill
                size={20}/>, roles: ['ADMIN', 'JOB_SEEKER', 'MENTOR']
        },
        {href: '/panel/users', label: 'Users', icon: <BsPeopleFill size={20}/>, roles: ['ADMIN']},
        {href: '/panel/job-position', label: 'Job Positions', icon: <FaLaptopCode size={20}/>, roles: ['ADMIN']},
        {href: '/panel/interview-type', label: 'Interview Types', icon: <BsCalendar3Week size={20}/>, roles: ['ADMIN']},
        {
            href: '/panel/change-password', label: 'Change Password', icon: <BsKey
                size={20}/>, roles: ['ADMIN', 'JOB_SEEKER', 'MENTOR']
        },
    ];
