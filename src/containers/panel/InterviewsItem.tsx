...
const InterviewsItem: FC<InterviewsItemProp> = (props) => {
    ...
    return (
        <div
            className='rounded-xl hover:border-t-[.1px] hover:border-[#F2A926] shadow-lg bg-white flex flex-col mt-3 p-6 gap-y-4 xs:gap-y-2  duration-200 transition-all ease-linear'>
