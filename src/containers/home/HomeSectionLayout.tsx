...
const HomeSectionLayout: FC<HomeLayoutProps> = (props) => {
    const {imageSource, title, description, buttonText, isLtr = false} = props
    return (
        <div className='lg:flex items-center mt-14'>
            ...
            <div
                ...
                <button className='btn btn-warning w-52 bg-[#F9A826] text-white rounded-md shadow-md mt-6 py-2 px-3'>
                    {buttonText}
                </button>
            </div>
